...
#
# Plot heatmap
def plot_heatmap_percent(a,b,total,pngfile,dpi) :
    ...
    aa = 100*a/total
    s1 = sns.heatmap(aa.T, ax=ax1, vmin=0, vmax=100, cmap='crest')
    ...
    bb = 100*b/total
    s2 = sns.heatmap(bb.T, ax=ax2, vmin=0, vmax=100, cmap='crest', yticklabels=yticks, xticklabels=xticks)
    #s2 = sns.heatmap(bb.T, ax=ax2, vmin=0, vmax=74, cmap='crest', yticklabels=yticks)
    ...
    ax2.set_xlabel("Duration (h)", fontsize=myfontsize)
