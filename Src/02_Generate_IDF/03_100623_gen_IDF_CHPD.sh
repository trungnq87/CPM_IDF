...
r03="R_03_100623_IDF_gen.Rscript"
currentdir=`pwd`
...
cd $tmpdir
time Rscript --vanilla r_${c}.Rscript -i ${in03}${i}_${s}.csv -g ${out03}/erl_${i}_${s}.csv -o ${out03}${i}_${s}.csv -a $alpha -b $nboot -f $frequency -d $minduration
EOF
        #
        sbatch s_${c}.script
        #
